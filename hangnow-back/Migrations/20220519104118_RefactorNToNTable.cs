...
{
    public partial class RefactorNToNTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ParticipansId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ParticipationsId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventUser", x => new { x.ParticipansId, x.ParticipationsId });
                    table.ForeignKey(
                        name: "FK_EventUser_AspNetUsers_ParticipansId",
                        column: x => x.ParticipansId,
